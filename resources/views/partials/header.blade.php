                    ...
                    <div class="dropdown">
                        <span class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img style="width: 30px; height: 30px;"
                                src="{{ asset('images/lang/english.png') }}" alt="">
                            @else
                            <img style="width: 30px; height: 30px;"
                                src="{{ asset('images/lang/indonesia.png') }}" alt="">
                            @endif
                        </span>
                        <ul class="dropdown-menu" style="min-width: 3rem;">
                          <li class="text-center">
                            @if (get_lang_code() == 'en')
                                <a href="{{ route('change-language', ['lang' => 'id', 'route' => \Route::currentRouteName()]) }}">
                                <img style="width: 30px; height: 30px;"
                                    src="{{ asset('images/lang/indonesia.png') }}" alt="">
                                </a>
                            @else
                                <a href="{{ route('change-language', ['lang' => 'en', 'route' => \Route::currentRouteName()]) }}">
                                    <img style="width: 30px; height: 30px;"
                                        src="{{ asset('images/lang/english.png') }}" alt="">
                                </a>
                            @endif
