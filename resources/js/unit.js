...
const initTable = () => {
    let createRoute = app_url + '/master/units/create';
        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    openGlobalModal(createRoute, i18n.global.create + ' ' + i18n.global.unit, {footer: true, target: `target-unit-action`})
                }
            }
        ],
        columns: [
